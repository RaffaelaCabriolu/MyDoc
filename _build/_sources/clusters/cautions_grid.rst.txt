...
This page contains some tips on how to get started with the usage of the gris system 
and how to familiarise with certain commands to make your work not invasive for 
other users. 

After you login to the grid cluster, you will be on your home folder. 
Here we are sharing few commands to have details about the hardware, software and operating system of each machine in the network.
-----------------
